...
//		private int delay;
//
//		public Tooltip(MouseOverEvent event, int offsetX, int offsetY,
//				final String text, final int delay, final String styleName) {
//			super(true);
//
//			this.delay = delay;
...
//			add(contents);
//
//			int left = event.getClientX() + offsetX;
//			int top = event.getClientY() + offsetY;
//
//			setPopupPosition(left, top);
//			setStyleName(styleName);
//		}
...
//			tooltip.hide();
//		}
//		tooltip = new Tooltip(event, offsetX, offsetY, text, delay, styleName);
//		tooltip.show();
//	}
//
//	@Override
...
//	}
//
//	public static void addTo(Widget widget, String texto, int demora,
//			String nombreEstilo) {
//		TooltipListener handler = new TooltipListener(texto, demora,
//				nombreEstilo);
//		
//				widget.addHandler(handler, MouseOverEvent.getType());
//		widget.addHandler(handler, MouseOutEvent.getType());
//
//	}
//
//	public static void addTo(Widget widget, String texto, int demora) {
//		addTo(widget, texto, demora, DEFAULT_TOOLTIP_STYLE);
//	}
//}