/**
 * UbicacionWSImplSoapBindingStub.java
 *
...
public class UbicacionWSImplSoapBindingStub extends org.apache.axis.client.Stub implements ar.edu.unicen.exa.galvarez.patogis.servidor.webservices.impl.UbicacionWSImpl {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://modelo.servidor.patogis.galvarez.exa.unicen.edu.ar", "Ubicacion"));
        oper.setReturnClass(ar.edu.unicen.exa.galvarez.patogis.servidor.modelo.Ubicacion[].class);
    ...
    public UbicacionWSImplSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public UbicacionWSImplSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public UbicacionWSImplSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (ar.edu.unicen.exa.galvarez.patogis.servidor.modelo.Ubicacion[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (ar.edu.unicen.exa.galvarez.patogis.servidor.modelo.Ubicacion[]) org.apache.axis.utils.JavaUtils.convert(_resp, ar.edu.unicen.exa.galvarez.patogis.servidor.modelo.Ubicacion[].class);
            }
        }
